...
const About = () => {
  ...
  <Fragment>
    ...
    <div>
      <img src="https://prasadyash2411.github.io/ecom-website/img/Band%20Members.png" className={classes.image} />
      <p className={classes.paragraph}>
        ...
        distinction, that arise from or to. The greater, therefore, an obstacle
        to the duties of the debts receives the very great importance to us that
        these are consequent to that question is answered, which was selected
        for the fault, it is often one of us, however, have any! Moreover, this
        is often not at once take the hardships of the life of harsh condemn, we
